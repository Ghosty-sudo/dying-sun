...
checks = {
    ...
    "router blocks action/secondary finger takeover": all(token in router for token in ["blocked_drag_ids", "can_recover_drag", "RELEASE_RECOVERY_GUARD_MS"]),
    ...
    "input regressions are CI-gated": "Act I movement regression" in ci and "Mobile touch input smoke" in ci,
